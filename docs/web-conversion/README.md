...
- **Backend**: Express.js (Node.js with JavaScript)
- **Frontend**: React
...
| [04-data-models.md](./04-data-models.md) | JavaScript data structures and JSDoc schemas |
| [05-service-layer.md](./05-service-layer.md) | Business logic migration from Python to JavaScript |
...
### Why Express.js with JavaScript?

- Lightweight and flexible for REST API development
- Large ecosystem of middleware and libraries
- Easy integration with SQL Server via `mssql` package
- Simple setup without build step required
...
- Same connection string format supported
